...
import { Heart, MessageSquare, Repeat, Send, Sparkles } from "lucide-react";
import { useEffect, useState } from "react";

export const PublicCommunityPostCard: React.FC<{ post: CommunityFeedPost }> = ({ post }) => {
  ...
  return (
    <div key={post?._id} className="border border-[#3f3f3f] rounded-xl p-4 bg-[#0f0f0f] hover:bg-[#1f1f1f] transition-colors mb-4">
